...
class QuantLabView:
    @staticmethod
    def render(data_dict, fg_df, vxn_df, news_df, leverage_asset, base_asset, trade_at, current_params, smart_params=None, start_d=None, end_d=None):
        ...
        with st.spinner('전 기간 데이터 시뮬레이션 및 분석 준비 중...'):
            cash_r = current_params.get('cash_ratio_pct', 0.0) / 100.0
            ...
            golden_history, closed_trades, signal_logs = StrategyEngine.run_golden_strategy(
                ...
                cash_r, long_start, long_end, current_params, trade_at, smart_params=smart_params
            )
